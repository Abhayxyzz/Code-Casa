...
model = joblib.load(r'C:\Users\ab665\OneDrive\Desktop\CodeCasa\Spam Detection\model.pkl')

# Load the TF-IDF vectorizer from the file
vectorizer = joblib.load(r'C:\Users\ab665\OneDrive\Desktop\CodeCasa\Spam Detection\vectorizer.pkl')
